#ifndef NLS_BENCHMARK_HPP
#define NLS_BENCHMARK_HPP
...
class Nls : public neolib::has_slots<>
{
    ...
    using Subject = neolib::signal<void(Rng_t&)>;
    using Foo = Benchmark::Nls;
...
chrono_timer Nls::s_timer;

} // namespace Benchmark -------------------------------------------------------

#endif // NLS_BENCHMARK_HPP
